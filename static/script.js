...
am5.ready(function() {
    ...
    var data = [
      {
        name: "Arimatéia",
        value: Number(cubArimateia.innerHTML),
        bulletSettings: { src: "/static/images.jpg" }
      },
      {
        name: "Fabio",
        value: Number(cubFabio.innerHTML),
        bulletSettings: { src: "/static/images.jpg" }
      },
      {
        name: "Zé carlos",
        value: Number(cubZecarlos.innerHTML),
        bulletSettings: { src: "/static/images.jpg" }
      },
      {
        name: "Cazé",
        value: Number(cubCaze.innerHTML),
        bulletSettings: { src: "/static/images.jpg" }
      },
      {
        name: "Kassio",
        value: Number(cubKassio.innerHTML),
        bulletSettings: { src: "/static/images.jpg" }
      },
      {
        name: "Vicente",
        value: Number(cubVicente.innerHTML),
        bulletSettings: { src: "/static/images.jpg" }
      }
